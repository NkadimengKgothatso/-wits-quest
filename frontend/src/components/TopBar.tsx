    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2">
          <span style={{ fontSize: 13, fontWeight: 700, color: 'white' }}>Kagiso Mthembu</span>
          <span
            className="badge"
          ...
          <div className="flex items-center gap-1" style={{ background: 'rgba(254, 214, 206, 0.15)', padding: '2px 6px', borderRadius: 10 }}>
            ...
            <span style={{ fontSize: 11, color: '#fed6ce', fontWeight: 700 }}>7d Streak</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 mt-1">
          <div className="stat-bar-track flex-1">
            <div className="xp-bar-fill stat-bar-fill" style={{ width: '68%', background: 'linear-gradient(90deg, #b0cbe6, #fed6ce)' }} />
          </div>
          <span style={{ fontSize: 10, color: '#a4b5d1', whiteSpace: 'nowrap' }}>2,450 / 3,600 XP</span>
        </div>
      </div>
