    ...
    <div style={{
      ...
      <div style={{ padding: '0 16px', maxWidth: 600, margin: '0 auto', marginBottom: 16 }}>
        <div className="glass-dark" style={{ borderRadius: 16, padding: 18, border: '1.5px solid #fed6ce', textAlign: 'center' }}>
          ...
          <div style={{ fontSize: 32, fontWeight: 900, color: '#fed6ce', margin: '4px 0' }}>1,540 Elo</div>
          <div style={{ fontSize: 12, fontWeight: 800, color: '#b0cbe6' }}>Diamond Tier · Rank #4 Campuswide</div>
