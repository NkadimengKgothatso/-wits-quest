...
**Related tasks:** [`SPRINT2_FEATURE_SELECTION_AND_TASK_GUIDE.md`](../sprints/SPRINT2_FEATURE_SELECTION_AND_TASK_GUIDE.md) Task 7.1
...
- Only workflow file: `.github/workflows/ci.yml` (repo root). No `.gitea/workflows/` directory exists yet, despite the README's file tree already documenting one.
