...
_This page is a starting scaffold — replace with what the team actually agrees on and update it if the workflow changes._
...
_Fill in: actual branch protection rules, code review requirements, CI checks (if any), and release/demo tagging convention once agreed with the team._
